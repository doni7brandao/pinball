...
(() => {
  ...
  function createHTMLBody() {
    ...
    current_score.appendChild(document.createTextNode("pontos"));
    ...
    high_score.appendChild(document.createTextNode("maior pts"));
    ...
    button_start.appendChild(document.createTextNode("Inicia"));
    ...
    button_reset.appendChild(document.createTextNode("Limpa"));
